...
<form action="<?php echo JRoute::_('index.php?option=com_rseventspro'); ?>" method="post" name="adminForm" id="adminForm">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td colspan="2" style="text-align:right;"><button type="submit" class="btn button" onclick="return validate_form();"><?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_SAVE_BTN'); ?></button></td>
		</tr>
	</table>
