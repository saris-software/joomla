...
class jefaqproModelCategorizedFaqs extends JModelItem
{
	/**
	 * total faqs
	 */
	...
	public function getItems()
	{
		...
		if( empty($faq) ) {
			...
			$query->select( 'cat.title AS category_title, cat.description AS category_description' );
			...
			$query->order($db->escape('faq.catid').' '.$db->escape($this->getState('list.direction', 'desc')));
