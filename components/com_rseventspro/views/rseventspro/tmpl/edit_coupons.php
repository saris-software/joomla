...
<div class="tab-pane" id="rsepro-edit-coupon<?php echo $coupon->id; ?>">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea rows="3" class="input-medium" name="coupons[<?php echo $coupon->id; ?>][code]" id="coupon_code<?php echo $coupon->id; ?>"><?php echo $coupon->code; ?></textarea>
	...
	<div class="control-group">
		<label for="coupon_discount<?php echo $coupon->id; ?>">
