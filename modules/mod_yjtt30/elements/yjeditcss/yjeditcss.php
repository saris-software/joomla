...
defined('_JEXEC') or die('Restricted access');
		...
		$path		= JPATH_ROOT.DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$yj_mod_name.DIRECTORY_SEPARATOR."css";
...
////////////////////////////////////////////////////////////////////
		...
		$yjme_file_dir 			= JPATH_ROOT."modules".DIRECTORY_SEPARATOR.$yj_mod_name.DIRECTORY_SEPARATOR."css".DIRECTORY_SEPARATOR;
		global $yjme_file;
	...
	function getedit_file(){
		...
		$yjme_file_dir 			= JPATH_ROOT.DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$yj_mod_name.DIRECTORY_SEPARATOR."css".DIRECTORY_SEPARATOR;
		$yjme_file 				= $yjme_file_dir.$yjme_name_only;
